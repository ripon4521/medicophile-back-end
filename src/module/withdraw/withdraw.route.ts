...
referWithdrawRouter.post(
  "/create-withdraw",
  validateRequest(withdrawValidation.createReferralWithdrawalZodSchema),
  withdrawController.createReferWithdraw,
);
...
referWithdrawRouter.patch(
  "/:id",
  validateRequest(withdrawValidation.updateReferralWithdrawalZodSchema),
  withdrawController.updateReferWithdraw,
);
