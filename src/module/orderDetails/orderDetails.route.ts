...
orderDetailsRouter.get("/ebook/:slug", orderDetailsController.getSingleEbook);
orderDetailsRouter.get('/ebook', orderDetailsController.getAllEbook);
export default orderDetailsRouter;5