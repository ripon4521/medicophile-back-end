...
courseReveiewRouter.post(
  ...
  validateRequest(coursReviewValidation.createCourseReviewZodSchema),
  courseReveiwController.createCourseReveiw,
);
courseReveiewRouter.patch(
  "/:id",
  validateRequest(coursReviewValidation.updateCourseReviewZodSchema),
  courseReveiwController.updateCourseReview,
);
courseReveiewRouter.get("/", courseReveiwController.getAllCourseReview);
courseReveiewRouter.get(
  "/:courseId",
  courseReveiwController.getSingleCourseReview,
);
