...
offlineBatchRouter.post('/create-offline-batch', validateRequest(offlineBatchValidation.createOfflineBatchSchema), offlineBatchController.createOfflineBatch);
offlineBatchRouter.get('/', offlineBatchController.getAllOfflineBatch);
offlineBatchRouter.patch('/:slug', validateRequest(offlineBatchValidation.updateOfflineBatchSchema), offlineBatchController.updateOfflineBatch);
