...
batchStudentRoute.post(
  ...
  validateRequest(batchStudentValidation.createBatchStudentSchema),
  batchStuentController.createBatchStudent,
);
...
batchStudentRoute.patch(
  "/:id",
  validateRequest(batchStudentValidation.updateBatchStudentSchema),
  batchStuentController.updateBacthStudent,
);
