...
enrollmentRoute.post('/createe-enrollment', validateRequest(enrolemntValidation.createEnrollmentSchema), enrollmentControlleer.createEnrollment);
...
enrollmentRoute.patch('/:id', validateRequest(enrolemntValidation.updateEnrollmentSchema), enrollmentControlleer.updateEnrollment);
