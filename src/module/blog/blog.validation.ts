...
const createBlogZodSchema = z.object({
    ...
    tags: z.array(z.string({ required_error: "Tags must be strings" }))
    ...
    coverPhoto: z.string({ required_error: "Cover photo URL is required" })
      .url({ message: "Cover photo must be a valid URL" }).optional(),
