...
cqAttempRouter.post(
  "/create-cqattemp",
  validateRequest(cqAttempsValidation.createCqAttemptValidationSchema),
  cqAttempController.createCqAttemp,
);
cqAttempRouter.get("/", cqAttempController.getAllCqAttemp);
cqAttempRouter.patch(
  "/update-cqattemp",
  validateRequest(cqAttempsValidation.updateCqAttemptValidationSchema),
  cqAttempController.updateCqAttemp,
);
