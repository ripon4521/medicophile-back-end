...
moduleDetailsRouter.post('/create-moduleDetails', validateRequest(moduleDetailsValidation.createIModuleDetailsSchema), moduleDetailsController.createModuleDetails);
...
moduleDetailsRouter.patch('/:id', validateRequest(moduleDetailsValidation.updateIModuleDetailsSchema),  moduleDetailsController.updateModuleDetails);
