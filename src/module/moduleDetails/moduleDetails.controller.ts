...
const createModuleDetails = catchAsync(async (req, res) => {
  ...
  const updateModuleDetails = catchAsync(async (req, res) => {
    const result = await moduleDetailsService.updateModuleDetails(req.params.id,req.body);
    sendResponse(res, {
  ...
  const getSingleModuleDetails = catchAsync(async (req, res) => {
    const result = await moduleDetailsService.getSingleModuleDetails(req.params.id);
    sendResponse(res, {
      statusCode: StatusCodes.OK,
