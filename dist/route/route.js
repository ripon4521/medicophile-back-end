...
const imageUpload_route_1 = __importDefault(
  require("../module/imageUpload/imageUpload.route"),
);
const pdf_route_1 = __importDefault(require("../module/pdf/pdf.route"));
const classQuizeQuestion_route_1 = __importDefault(
  require("../module/classQuizeQuestion/classQuizeQuestion.route"),
);
const cqAttemp_route_1 = __importDefault(
  require("../module/cqAttemp/cqAttemp.route"),
);
const cqMarking_route_1 = __importDefault(
  require("../module/cqMarking/cqMarking.route"),
);
const docs_route_1 = __importDefault(require("../module/docs/docs.route"));
const gapsQuestion_route_1 = __importDefault(
  require("../module/gapsQuestion/gapsQuestion.route"),
);
const gapAnswer_route_1 = __importDefault(
  require("../module/gapAnswer/gapAnswer.route"),
);
const gapAttemp_route_1 = __importDefault(
  require("../module/gapsAttemp/gapAttemp.route"),
);
const liveClass_route_1 = __importDefault(
  require("../module/liveClass/liveClass.route"),
);
const media_route_1 = __importDefault(require("../module/media/media.route"));
const blogController_route_1 = __importDefault(
  require("../module/blogCategory/blogController.route"),
);
...
const blogComment_route_1 = __importDefault(
  require("../module/blogComment/blogComment.route"),
);
const coupon_route_1 = __importDefault(
  require("../module/coupon/coupon.route"),
);
const purchaseToken_route_1 = __importDefault(
  require("../module/purchaseToken/purchaseToken.route"),
);
const purchase_route_1 = __importDefault(
  require("../module/purchase/purchase.route"),
);
const paymentDetails_route_1 = __importDefault(
  require("../module/paymentDetails/paymentDetails.route"),
);
const mcq_route_1 = __importDefault(require("../module/mcq/mcq.route"));
const mcqAttemp_route_1 = __importDefault(
  require("../module/mcqAttemp/mcqAttemp.route"),
);
const bookCategory_route_1 = __importDefault(
  require("../module/bookCategory/bookCategory.route"),
);
const notice_route_1 = __importDefault(
  require("../module/notice/notice.route"),
);
const product_route_1 = __importDefault(
  require("../module/product/product.route"),
);
const courseDetails_route_1 = __importDefault(
  require("../module/courseDetails/courseDetails.route"),
);
const courseReview_route_1 = __importDefault(
  require("../module/courseReview/courseReview.route"),
);
