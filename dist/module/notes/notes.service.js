...
const getAllNotes = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notes_model_1.default
...
const updateNote = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const update = yield notes_model_1.default.findOneAndUpdate(
      { slug },
      payload,
      {
        new: true,
...
const deleteNote = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notes_model_1.default.findOneAndUpdate(
      { slug },
      {
        isDeleted: true,
