...
noteRouter.get("/:id", notes_controller_1.notesController.getSingleNote);
noteRouter.patch("/:id", (0, validateRequest_1.default)(notes_validation_1.noteValidation.updateNotesSchema), notes_controller_1.notesController.updateNote);
noteRouter.delete("/:id", notes_controller_1.notesController.deleteNote);
