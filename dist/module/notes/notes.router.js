...
noteRouter.post(
  ...
  (0, validateRequest_1.default)(
    notes_validation_1.noteValidation.createNotesSchema,
  ),
  notes_controller_1.notesController.createNote,
);
...
noteRouter.get(
  "/single-note/:slug",
  notes_controller_1.notesController.getSingleNote,
);
noteRouter.patch(
  "/:slug",
  (0, validateRequest_1.default)(
    notes_validation_1.noteValidation.updateNotesSchema,
  ),
  notes_controller_1.notesController.updateNote,
);
