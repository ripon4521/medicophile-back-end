...
const createCategory = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield category_services_1.categoryService.createCategory(
      req.body,
    );
...
const getAllCategory = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield category_services_1.categoryService.getallCategory(query);
    (0, sendResponse_1.default)(res, {
...
const getSingleCategory = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield category_services_1.categoryService.singleCategoryget(id);
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
...
const updateCategory = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield category_services_1.categoryService.updateCatgory(
      id,
      payload,
    );
    (0, sendResponse_1.default)(res, {
