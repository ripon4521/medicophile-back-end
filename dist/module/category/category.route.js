...
categiryRouter.post(
  ...
  (0, validateRequest_1.default)(
    category_validation_1.categoryvalidation.createCategorySchema,
  ),
...
categiryRouter.patch(
  "/:id",
  (0, validateRequest_1.default)(
    category_validation_1.categoryvalidation.updateCategoryValidationSchema,
  ),
  category_controller_1.categoryController.updateCategory,
);
categiryRouter.delete(
  "/:id",
