...
const createStudentsIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const sms = yield (0, sendSms_1.sendSMS)(
        payload.phone,
      ...
      // console.log(sms)
      const createdStudent = yield student_model_1.default.create(
        [studentData],
        {
          session,
        },
      ...
      yield student_model_1.default.updateOne(
...
const createAdmiIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const createdAdmin = yield admin_model_1.default.create([adminData], {
        session,
      });
      const hashedPassword = yield bcrypt_1.default.hash(plainPassword, 12);
      ...
      const userData = {
        name:
          (_a = createdAdmin[0]) === null || _a === void 0 ? void 0 : _a.name,
        status:
          (_b = createdAdmin[0]) === null || _b === void 0 ? void 0 : _b.status,
        role:
          (_c = createdAdmin[0]) === null || _c === void 0 ? void 0 : _c.role,
        profile_picture:
          (_d = createdAdmin[0]) === null || _d === void 0
            ? void 0
            : _d.profile_picture,
        phone:
          (_e = createdAdmin[0]) === null || _e === void 0 ? void 0 : _e.phone,
        password: hashedPassword,
        email:
          (_f = createdAdmin[0]) === null || _f === void 0 ? void 0 : _f.email,
        isDeleted:
          (_g = createdAdmin[0]) === null || _g === void 0
            ? void 0
            : _g.isDeleted,
        deletedAt:
          (_h = createdAdmin[0]) === null || _h === void 0
            ? void 0
            : _h.deletedAt,
      };
      const newUser = yield user_model_1.UserModel.create([userData], {
...
const createFacultysIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    const session = yield mongoose_1.default.startSession();
    session.startTransaction();
    try {
      ...
      const userData = {
        name:
          (_a = createdFaculty[0]) === null || _a === void 0 ? void 0 : _a.name,
        status:
          (_b = createdFaculty[0]) === null || _b === void 0
            ? void 0
            : _b.status,
        role:
          (_c = createdFaculty[0]) === null || _c === void 0 ? void 0 : _c.role,
        profile_picture:
          (_d = createdFaculty[0]) === null || _d === void 0
            ? void 0
            : _d.profile_picture,
        phone:
          (_e = createdFaculty[0]) === null || _e === void 0
            ? void 0
            : _e.phone,
        password: hashedPassword,
        email:
          (_f = createdFaculty[0]) === null || _f === void 0
            ? void 0
            : _f.email,
        isDeleted:
          (_g = createdFaculty[0]) === null || _g === void 0
            ? void 0
            : _g.isDeleted,
        deletedAt:
          (_h = createdFaculty[0]) === null || _h === void 0
            ? void 0
            : _h.deletedAt,
      };
      const newUser = yield user_model_1.UserModel.create([userData], {
      ...
      // Step 3: Update admin with the newly created userId
      yield faculty_model_1.default.updateOne(
