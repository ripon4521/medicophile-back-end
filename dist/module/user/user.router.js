...
userRouter.post("/create-admin", (0, validateRequest_1.default)(admin_validation_1.adminValidation.createAdminValidationSchema), user_controller_1.userController.createAdmin);
...
userRouter.patch("/change-password", (0, validateRequest_1.default)(user_validation_1.changePasswordValidation), user_controller_1.userController.changePassord);
