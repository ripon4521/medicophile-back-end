...
const bookCategory_model_1 = __importDefault(
  require("../bookCategory/bookCategory.model"),
);
const user_model_1 = require("../user/user.model");
const product_model_1 = require("./product.model");
const querybuilder_1 = __importDefault(require("../../builder/querybuilder"));
const createProduct = (paload) =>
...
const getAllProductFromDb = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateProduct = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const update = yield product_model_1.ProductModel.findOneAndUpdate(
      { slug },
      payload,
      {
        new: true,
