...
blogCategoryRoute.post(
  ...
  (0, validateRequest_1.default)(
    blogCategory_validation_1.blogCategoryValidation.createBlogCategorySchema,
  ),
  blogCategory_controller_1.blogCategoryController.createBlogCategory,
);
blogCategoryRoute.get(
  "/",
  blogCategory_controller_1.blogCategoryController.getAllBlogCategory,
);
blogCategoryRoute.get(
  "/:slug",
  blogCategory_controller_1.blogCategoryController.getSingleBlogCategory,
);
blogCategoryRoute.patch(
  "/:slug",
  (0, validateRequest_1.default)(
    blogCategory_validation_1.blogCategoryValidation.updateBlogCategorySchema,
  ),
  blogCategory_controller_1.blogCategoryController.updateBlogCategory,
);
blogCategoryRoute.delete(
  "/:slug",
  blogCategory_controller_1.blogCategoryController.deleteBlogCategory,
);
