...
const createBlogCategory = (payload) =>
...
const getAllBlogCategory = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      blogCategory_model_1.default,
      query,
    )
      .search(["title"])
      .filter()
...
const getSingleBlogCatgeory = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blogCategory_model_1.default
      .findOne({ slug })
      .populate("createdBy");
    if (!result) {
      throw new AppError_1.default(
...
const updateBlogCategory = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Update operation
    const update = yield blogCategory_model_1.default.findOneAndUpdate(
      { slug },
      payload,
      {
        new: true,
...
const deleteBlogCategory = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blogCategory_model_1.default.findOneAndUpdate(
      { slug },
      {
        isDeleted: true,
