...
const blogCategory_model_1 = __importDefault(
  require("../blogCategory/blogCategory.model"),
);
const user_model_1 = require("../user/user.model");
const createBlog = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const category = yield blogCategory_model_1.default.findOne({
...
const updateBlog = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.default.findOneAndUpdate(
      { slug },
      payload,
      {
        runValidators: true,
