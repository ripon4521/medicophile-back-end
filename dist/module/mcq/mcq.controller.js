...
const createMcq = (0, catchAsync_1.default)((req, res) =>
...
const updateMCQ = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id) {
    ...
    const result = yield mcq_service_1.mcqQuestionService.updateMcq(
      id,
      payload,
    );
    (0, sendResponse_1.default)(res, {
...
const deleteMCQ = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id) {
      throw new AppError_1.default(
