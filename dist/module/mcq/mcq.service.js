...
const getAllMcq = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
      throw new AppError_1.default(
        http_status_codes_1.StatusCodes.BAD_REQUEST,
        "Failed  to get MCQ Question",
      );
    }
    return result;
  });
const updateMcq = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield mcq_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        runValidators: true,
...
const getSpcificMcq = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield mcq_model_1.default
