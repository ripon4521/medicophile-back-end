...
mcqRoute.post(
  ...
  (0, validateRequest_1.default)(
    mcq_validation_1.mcqValidation.createMcqQuestionSchema,
  ),
  mcq_controller_1.mcqQuestiionController.createMcq,
);
...
mcqRoute.patch(
  "/:id",
  (0, validateRequest_1.default)(
    mcq_validation_1.mcqValidation.updateMcqQuestionSchema,
  ),
  mcq_controller_1.mcqQuestiionController.updateMCQ,
);
