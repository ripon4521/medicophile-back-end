...
enrollmentRoute.post("/create-enrollment", (0, validateRequest_1.default)(newEnrollment_validation_1.enrolemntValidation.createEnrollmentSchema), newEnrollment_controller_1.enrollmentControlleer.createEnrollment);
enrollmentRoute.get("/", (0, auth_1.authUser)('superAdmin', "admin", 'teacher'), (0, auth_1.onlyAdminAndFacultyAndStudent)("superAdmin", "admin", "teacher", "student"), newEnrollment_controller_1.enrollmentControlleer.getEnrollment);
