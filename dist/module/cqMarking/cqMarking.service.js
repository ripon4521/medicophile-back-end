...
const getAllCqMarking = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cqMarking_model_1.default
...
const getSpecifUserCqMarking = (studentId, examId, questionId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateCqMarking = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const check = yield cqMarking_model_1.default.findOne({ _id: _id });
    if (!check) {
      throw new AppError_1.default(
        http_status_codes_1.StatusCodes.BAD_REQUEST,
        "invalid cq marking id",
      );
    }
    const update = yield cqMarking_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        runValidators: true,
