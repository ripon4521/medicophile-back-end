...
const getAllCqMarking = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield cqMarking_service_1.cqMarkingService.getAllCqMarking(query);
    (0, sendResponse_1.default)(res, {
...
const getSpecificCqMarking = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield cqMarking_service_1.cqMarkingService.getSpecifUserCqMarking(
        studentId,
        examId,
        questionId,
      );
