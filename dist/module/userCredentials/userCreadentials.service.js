...
const getAllCredentials = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield userCredentials_model_1.UserCredentialsModel.find({
      isDeleted: false,
    }).populate("studentId");
    if (!result) {
...
const getSingleCrtedentials = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield userCredentials_model_1.UserCredentialsModel.findOne({
      _id,
    }).populate("studentId");
    if (!result) {
      throw new AppError_1.default(
