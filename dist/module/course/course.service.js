...
const createCourseIntoDb = (payload) =>
...
const getAllCoursesFromDb = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const finalQuery = Object.assign(Object.assign({}, query), {
      status: "active",
    });
    ...
    const ongoingCourses = result.filter((course) => {
      ...
      const endDate = (0, date_fns_1.addMonths)(
...
const getCourseById = (slug, userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateCourseInDb = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const update = yield course_model_1.default.findOneAndUpdate(
      { slug },
      payload,
      {
        new: true,
...
const deleteCourseFromDb = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield course_model_1.default.findOneAndUpdate(
      { slug },
      {
        isDeleted: true,
...
const getUserPurchasedCourses = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
