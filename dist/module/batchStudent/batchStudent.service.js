...
const createBatchStudent = (payload) =>
...
const getAllBatchStudents = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      batchStudent_model_1.BatchStudentModel,
      query,
    )
      .search(["studentId"])
      .filter()
...
const updateBatchStudent = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield batchStudent_model_1.BatchStudentModel.findOneAndUpdate(
        { _id },
        payload,
        {
          runValidators: true,
