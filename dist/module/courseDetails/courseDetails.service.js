...
const createCourseDetails = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const exist = yield courseDetails_model_1.default.findOne({ courseId: payload.courseId });
    if (!course) {
...
const getSingleCourseDetails = (courseId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseDetails_model_1.default.findOne({ courseId }).populate("courseId").populate("instructors");
    return result;
});
