...
const createCourseDetails = (payload) =>
...
const getAllCourseDetails = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      courseDetails_model_1.default,
      query,
    )
      .search(["syllabus"])
      .filter()
...
const updateCourseDetails = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Update operation
    const update = yield courseDetails_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        new: true,
...
const getSingleCourseDetails = (courseId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseDetails_model_1.default
      .findOne({ courseId })
      .populate("courseId")
      .populate("instructors");
    return result;
  });
const deleteCourseDetails = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseDetails_model_1.default.findOneAndDelete({
      _id,
    });
    return result;
  });
