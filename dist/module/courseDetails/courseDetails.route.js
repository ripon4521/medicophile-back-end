...
courseDetailsRouter.post("/create-course-details", (0, auth_1.authUser)(), (0, auth_1.onlyAdminAndFacultyAndStudent)("admin", "superAdmin", "teacher"), (0, validateRequest_1.default)(courseDetails_validation_1.courseDetailsValidation.createCourseDetailsZodSchema), courseDetails_controller_1.courseDetailsController.createCourseDetails);
...
courseDetailsRouter.delete("/:id", (0, auth_1.authUser)(), (0, auth_1.onlyAdminAndFacultyAndStudent)("admin", "superAdmin"), courseDetails_controller_1.courseDetailsController.deleteCourseDetails);
