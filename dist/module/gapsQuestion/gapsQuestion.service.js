...
const cretaeGapsQuestion = (payload) =>
...
const getAllGapsQuestion = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      gapsQuestion_model_1.default,
      query,
    )
      ...
      .populate([
        {
          path: "examId",
          select:
            "examTitle examType validTime scheduleDate courseId moduleId ",
        },
      ])
      .populate([
        {
...
const updateGapsQuestion = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield gapsQuestion_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        runValidators: true,
...
const getSpcificGaps = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield gapsQuestion_model_1.default
