...
const getAllLiveClass = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
      throw new AppError_1.default(
        http_status_codes_1.StatusCodes.BAD_REQUEST,
        "Failed  to get Live Class",
      );
    }
    return result;
  });
const updateLiveClass = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const get = yield liveClass_model_1.default.findOneAndUpdate(
      { slug },
      payload,
      {
        runValidators: true,
...
const singleGetLiveClass = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const get = yield liveClass_model_1.default
      .findOne({ slug })
      .populate("courseId")
      .populate("createdBy");
    if (!get) {
