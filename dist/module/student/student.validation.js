...
const createStudentSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        gurdianPhone: zod_1.z.string().min(11, "Gurdian Phone too small. Number is must be 11 charachters.").max(11, 'Gurdian phone number is must be 11 charcters long').optional(),
