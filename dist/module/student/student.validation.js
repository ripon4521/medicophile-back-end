...
//       student_phone: z
//         .string()
//         .regex(/^\+?[0-9]{10,15}$/, "Invalid student phone number")
//         .optional(),
...
//       subjects_taken: z
//         .array(z.string())
//         .min(1, "At least one subject must be taken"),
//       total_gpa: z
//         .number()
...
//         .number()
//         .int()
//         .positive("Class rank must be a positive integer")
//         .optional(),
//       attendance_percentage: z
//         .number()
//         .min(0)
//         .max(100, "Attendance percentage must be between 0-100")
//         .optional(),
...
//     userId: z
//       .instanceof(Types.ObjectId, { message: "Invalid user ID" })
//       .optional(),
//     profile_picture: z.string().url().optional(),
