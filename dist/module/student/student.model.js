...
stundetSchema.pre("findOneAndUpdate", function (next) {
  ...
  if (
    (update === null || update === void 0 ? void 0 : update.isDeleted) === true
  ) {
    update.deletedAt = new Date(new Date().getTime() + 6 * 60 * 60 * 1000); // ✅ BD Time (UTC+6)
  }
  next();
});
stundetSchema.pre("save", function (next) {
...
stundetSchema.post("save", function (doc, next) {
  return __awaiter(this, void 0, void 0, function* () {
    doc.password = "";
    next();
  });
});
const studentModel = mongoose_1.default.model("Students", stundetSchema);
