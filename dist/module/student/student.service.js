...
const getAllStudents = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield student_model_1.default.find().populate('user');
    return result;
});
...
const deleteStudentById = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userId = (_a = student.user) === null || _a === void 0 ? void 0 : _a._id;
        // StudentUserModel theke delete
        yield student_model_1.default.findOneAndDelete({ _id }).session(session);
