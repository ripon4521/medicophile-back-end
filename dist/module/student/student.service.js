...
const getStudentById = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield student_model_1.default.findOne({ _id }).populate("userId");
    return result;
});
const deleteStudentById = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const student = yield student_model_1.default.findOne({ _id }).session(session);
        if (!student) {
...
const updateStudent = (_id, updateData) => __awaiter(void 0, void 0, void 0, function* () {
    const session = yield mongoose_1.default.startSession();
    session.startTransaction();
    try {
        const student = yield student_model_1.default.findById(_id).session(session);
        if (!student) {
            throw new Error("Student not found");
        }
        // Update Student model
        const updatedStudent = yield student_model_1.default.findByIdAndUpdate(_id, updateData, { new: true, runValidators: true, session });
        if (!updatedStudent) {
            throw new Error("Failed to update student");
        }
        const userUpdateData = {};
        const updateStudentData = yield student_model_1.default.findById(_id).session(session);
        userUpdateData.email = updateStudentData === null || updateStudentData === void 0 ? void 0 : updateStudentData.email;
        userUpdateData.role = updateStudentData === null || updateStudentData === void 0 ? void 0 : updateStudentData.role;
        ...
        // Update user model
        const updatedUser = yield user_model_1.UserModel.findByIdAndUpdate(student.userId, userUpdateData, { new: true, runValidators: true, session });
        if (!updatedUser) {
