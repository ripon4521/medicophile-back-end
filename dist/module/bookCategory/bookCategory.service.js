...
const createBookCategory = (payload) =>
...
const updateBookCategory = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield bookCategory_model_1.default.findOneAndUpdate(
      { slug },
      payload,
      {
        runValidators: true,
...
const getAllBookCategory = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      bookCategory_model_1.default,
      query,
    )
...
const getSingleBookCategory = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
