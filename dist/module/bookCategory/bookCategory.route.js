...
bookCategoryRoute.post(
  ...
  (0, validateRequest_1.default)(
    bookCategory_validation_1.bookCategoryValidation
      .createBookCategoryValidationSchema,
  ),
  bookCategory_controller_1.bookCategoryontroller.createBookCategory,
);
bookCategoryRoute.get(
  "/",
  bookCategory_controller_1.bookCategoryontroller.getAllBookCategory,
);
bookCategoryRoute.get(
  "/:slug",
  bookCategory_controller_1.bookCategoryontroller.getSingleBookCategory,
);
bookCategoryRoute.patch(
  ...
  bookCategory_controller_1.bookCategoryontroller.updateBookCategory,
);
bookCategoryRoute.delete(
  "/:slug",
  bookCategory_controller_1.bookCategoryontroller.deleteBookCategory,
);
