...
const FacultyUserSchema = new mongoose_1.Schema({
    role: {
        type: String,
        enum: ['faculty'],
        required: true,
...
FacultyUserSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingStudent = yield mongoose_1.default.model("Facultys").findOne({
...
const FacultyUserModel = mongoose_1.default.model("Facultys", FacultyUserSchema);
