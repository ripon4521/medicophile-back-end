...
mediaRoute.post(
  ...
  (0, validateRequest_1.default)(
    media_validation_1.mediaValidation.createMediaZodSchema,
  ),
  media_controller_1.mediaController.createMedia,
);
...
mediaRoute.patch(
  "/:slug",
  (0, validateRequest_1.default)(
    media_validation_1.mediaValidation.updateMediaZodSchema,
  ),
  media_controller_1.mediaController.updateMedia,
);
