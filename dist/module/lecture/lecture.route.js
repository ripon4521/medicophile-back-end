...
lectureRouter.patch("/:id", (0, validateRequest_1.default)(lecture_validation_1.lectureValidation.updateLectureSchema), lecture_controller_1.lectureController.updateLecture);
lectureRouter.get("/", lecture_controller_1.lectureController.getLecture);
lectureRouter.get("/:id", lecture_controller_1.lectureController.getSingleLecture);
lectureRouter.delete("/:id", lecture_controller_1.lectureController.deleteLecture);
