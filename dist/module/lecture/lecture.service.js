...
const createLecture = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const modul = yield modules_model_1.default.findOne({
...
const updateLecture = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const update = yield lecture_model_1.default.findOneAndUpdate(
        { slug },
        payload,
        {
          new: true,
...
const deleteLecture = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deleted = yield lecture_model_1.default.findOneAndUpdate(
      { slug },
      {
        isDeleted: true,
...
const getAllLecture = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield lecture_model_1.default
...
const getSpcificLecture = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield lecture_model_1.default
      .find({ moduleId: id, isDeleted: false })
      .populate("createdBy")
      .populate({
        path: "courseId",
        populate: { path: "category" },
