...
const mcqAttemp_model_1 = __importDefault(
  require("../mcqAttemp/mcqAttemp.model"),
);
...
const getStudentsByExamService = (examId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Fetch attempts from all models and populate studentId
    const cqAttempts = yield cqAttemp_model_1.default
      .find({ examId })
      .populate("studentId");
    const gapAttempts = yield gapAttemp_model_1.default
      .find({ examId })
      .populate("studentId");
    const mcqAttempts = yield mcqAttemp_model_1.default
      .find({ examId })
      .populate("studentId");
    const allStudents = [
