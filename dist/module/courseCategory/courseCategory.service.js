...
const createCourseCategory = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExist = yield courseCategory_model_1.default.findOne({
      title: payload.title,
    });
    if (isExist) {
      throw new AppError_1.default(
...
const getAllCourseCategory = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      courseCategory_model_1.default,
      query,
    )
      .search(["title"])
      .filter()
...
const getSingleCourseCatgeory = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseCategory_model_1.default
      .findOne({
        slug,
        isDeleted: false,
      })
