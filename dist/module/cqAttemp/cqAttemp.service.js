...
const createCqAttemps = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Failed to create Cq Attemps. Please cheack and try again");
    }
    return result;
});
const getAllCqAttemps = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cqAttemp_model_1.default.find({ isDeleted: false }).populate('studentId').populate('examId').populate('checkedBy');
    if (!result) {
