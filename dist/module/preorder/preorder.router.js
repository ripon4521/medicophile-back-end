...
preOrderRouter.post('/craete-preOrder', preorder_controller_1.preorderController.createPreOrder);
...
preOrderRouter.patch('/:id', preorder_controller_1.preorderController.updatePreOrder);
