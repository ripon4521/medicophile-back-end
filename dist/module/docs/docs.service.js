...
const updateDocs = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield docs_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        runValidators: true,
