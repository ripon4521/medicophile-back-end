...
docsRouter.post(
  ...
  (0, validateRequest_1.default)(
    docs_validation_1.docsValidation.createDocsSchema,
  ),
  docs_controller_1.docsController.createDocs,
);
...
docsRouter.patch(
  "/update-docs",
  (0, validateRequest_1.default)(
    docs_validation_1.docsValidation.updateDocsSchema,
  ),
  docs_controller_1.docsController.updateDocs,
);
