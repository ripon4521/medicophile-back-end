...
const createDocs = (0, catchAsync_1.default)((req, res) =>
...
const updateDocs = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.body;
    if (!_id) {
...
const deleteDocs = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.body;
    if (!_id) {
      throw new AppError_1.default(
...
const getAllDocs = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const singleDocs = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
