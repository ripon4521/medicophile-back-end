...
orderDetailsRouter.get(
  "/",
  orderDetails_controller_1.orderDetailsController.getAllOrderDetails,
);
orderDetailsRouter.patch(
  "/:id",
  (0, validateRequest_1.default)(
    orderDetails_validation_1.updateOrderDetailsZodSchema,
  ),
  orderDetails_controller_1.orderDetailsController.updateOrderDetails,
);
orderDetailsRouter.delete(
  "/:id",
  orderDetails_controller_1.orderDetailsController.deleteOrderDetails,
);
