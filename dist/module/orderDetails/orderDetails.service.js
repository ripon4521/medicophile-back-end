...
const getAllOrderDetailsFromDb = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      orderDetails_model_1.default,
      query,
    )
      .search(["name", "address"])
      .filter()
...
const updateOrderDetailsAndOrderStatus = (orderDetailsId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Update orderDetails
    yield orderDetails_model_1.default.updateOne(
      { _id: orderDetailsId },
      payload,
    );
...
const deleteOrderDeails = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield orderDetails_model_1.default.findOneAndUpdate(
      { _id },
      {
        isDeleted: true,
