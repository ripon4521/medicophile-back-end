...
noticeRoute.post(
  ...
  (0, validateRequest_1.default)(
    notice_validation_1.noticeValidation.createNoticeSchema,
  ),
  notice_controller_1.noticeController.createNotice,
);
...
noticeRoute.patch(
  "/:slug",
  (0, validateRequest_1.default)(
    notice_validation_1.noticeValidation.updateNoticeSchema,
  ),
  notice_controller_1.noticeController.updateNotice,
);
