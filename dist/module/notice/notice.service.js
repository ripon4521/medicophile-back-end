...
const getAllNoticeFromDb = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      notice_model_1.default,
      query,
    )
...
const deleteNotice = (slug) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notice_model_1.default.findOneAndUpdate(
      { slug },
      {
        isDeleted: true,
...
const updateNotice = (slug, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield notice_model_1.default.findOneAndUpdate(
      { slug },
      payload,
