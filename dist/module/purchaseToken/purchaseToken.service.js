...
const getAllPurchasseToken = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      purchaseToken_model_1.default,
      query,
    )
      .search([""])
      .filter()
    ...
    if (!result) {
      throw new AppError_1.default(
        http_status_codes_1.StatusCodes.BAD_REQUEST,
        "Failed to get purchase token",
      );
    }
    return result;
  });
const updatePurchaseToken = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!_id) {
      throw new AppError_1.default(
        http_status_codes_1.StatusCodes.BAD_REQUEST,
    ...
    const result = yield purchaseToken_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        runValidators: true,
