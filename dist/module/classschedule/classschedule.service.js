...
const createClassscheduleIntoDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      throw new Error(
        "An unknown error occurred while creating the class schedule.",
      );
    }
  });
const getsingleClassscheduleById = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield classschedule_model_1.default
      .findOne({ _id })
      .populate("courseId")
      .populate("facultyId");
    return result;
  });
const updateClassscheduleInDb = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (payload.day && Array.isArray(payload.day)) {
      for (const dayUpdate of payload.day) {
        ...
        const result = yield classschedule_model_1.default.updateOne(
          { _id, "day._id": dayUpdate._id },
          {
            $set: {
              "day.$.day": updateData.day,
              "day.$.time": updateData.time,
            },
          },
        );
...
const deleteClassscheduleFromDb = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield classschedule_model_1.default.findOneAndDelete({
      _id,
    });
    return result;
  });
const getAllClassscheduleIntoDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const result = yield classschedule_model_1.default
        .find()
