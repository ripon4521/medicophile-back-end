...
mcqAttempRouter.post(
  "/submit",
  (0, validateRequest_1.default)(mcqAttemp_validation_1.mcqAttemptSchema),
  mcqAttemp_controller_1.mcqAttempController.submitMcqAttemptController,
);
mcqAttempRouter.get(
  "/:id",
  mcqAttemp_controller_1.mcqAttempController.getSpeecificMccq,
);
