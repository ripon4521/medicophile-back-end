...
ModuleSchema.pre("save", function (next) {
  if (this.isModified("moduleTitle")) {
    this.slug = (0, slugify_1.default)(this.moduleTitle, {
      lower: true,
      strict: true,
    });
  }
...
ModuleSchema.pre("findOneAndUpdate", function (next) {
  ...
  if (update === null || update === void 0 ? void 0 : update.moduleTitle) {
    update.slug = (0, slugify_1.default)(update.moduleTitle, {
      lower: true,
      strict: true,
    });
  }
