...
const createModule = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Failed to create module, please try again and check your from data ");
    }
    return result;
});
const getAllModule = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(modules_model_1.default, query)
        .search(["moduleTitle"])
        .filter()
        .sort()
        .paginate()
...
const getSingleModule = (slug) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield modules_model_1.default.findOne({ slug })
        .populate("createdBy")
        .populate({
        path: "courseId",
        populate: { path: "category" },
...
const updateModule = (slug, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!update) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Failed to update data , please check data and try again");
    }
    return update;
});
const deleteModule = (slug) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield modules_model_1.default.findOneAndUpdate({ slug }, {
        isDeleted: true,
