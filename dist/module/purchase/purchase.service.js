...
const purchaseToken_model_1 = __importDefault(
  require("../purchaseToken/purchaseToken.model"),
);
const user_model_1 = require("../user/user.model");
const purchase_model_1 = require("./purchase.model");
const mongoose_1 = __importDefault(require("mongoose"));
const paymentDetails_model_1 = __importDefault(
  require("../paymentDetails/paymentDetails.model"),
);
...
const createPurchase = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const purchaseToken = yield purchaseToken_model_1.default
        .findOne({
          _id: payload.purchaseToken,
        })
        .session(session);
      const issuedBy = yield user_model_1.UserModel.findOne({
        _id: payload.issuedBy,
      }).session(session);
      ...
      yield purchaseToken_model_1.default.updateOne(
        { _id: payload.purchaseToken },
        { status: tokenStatus },
        { session },
      );
      let result = null;
      if (payload.paymentStatus === "Paid") {
        result = yield purchase_model_1.PurchaseModel.create([payload], {
          session,
        });
...
const getAllPurchase = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      purchase_model_1.PurchaseModel,
      query,
    )
      .search(["status"])
      .filter()
...
const deletePurchase = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield purchase_model_1.PurchaseModel.findOneAndUpdate(
      { _id },
      {
        isDeleted: false,
...
const updatePurchase = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield purchase_model_1.PurchaseModel.findOneAndUpdate(
      { _id },
      payload,
