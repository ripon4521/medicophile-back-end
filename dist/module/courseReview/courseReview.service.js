...
const createCourseReview = (payload) =>
...
const getAllCourseReveiw = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new querybuilder_1.default(
      courseReview_model_1.default,
      query,
    )
      .search(["review"])
      .filter()
...
const updateCourseReview = (_id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Update operation
    const update = yield courseReview_model_1.default.findOneAndUpdate(
      { _id },
      payload,
      {
        new: true,
...
const deleteCourseReveiw = (_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseReview_model_1.default.findOneAndUpdate(
      { _id },
      {
        isDeleted: true,
...
const getSingleCourseReveiw = (courseId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseReview_model_1.default
      .find({ courseId })
      .populate("courseId")
      .populate("studentId");
    return result;
