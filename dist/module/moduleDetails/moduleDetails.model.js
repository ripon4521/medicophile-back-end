...
const moduleDetailsSchema = new mongoose_1.Schema({
    courseId: {
...
const ModuleDetails = mongoose_1.default.model("ModuleDetails", moduleDetailsSchema);
exports.default = ModuleDetails;
